...
@callback(Output("loading-stat_sheet", "children"),Input(component_id='group_stats_path',component_property='value'))
...
@callback(Output("loading-group_data", "children"),Input(component_id='group_data_path',component_property='value'))
...
@callback(Output("loading-indiv_data", "children"),Input(component_id='indiv_data_path',component_property='value'))
...
@callback(Output(component_id='prompt-container',component_property='children'),Input(component_id='select-mode',component_property='value'),prevent_initial_call=True)
...
@callback(Output(component_id='output-container', component_property='children', allow_duplicate=True),Input(component_id='prompt_input', component_property='value'),prevent_initial_call=True)
